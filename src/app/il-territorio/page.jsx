...
// 1. META TAG SEO (Ottimizzati per intercettare turisti, escursionisti e motociclisti)
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.tuodominio.it/il-territorio', // Cambia con il tuo dominio definitivo
  },
  openGraph: {
...
export default function Page() {
  // 2. DATI STRUTTURATI JSON-LD (WebPage + ItemList delle attività sul territorio)
  // Aiuta Google a capire la divisione interna della pagina per creare i sotto-link nei risultati
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.tuodominio.it/il-territorio#webpage",
        ...
        "breadcrumb": {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "https://www.tuodominio.it/il-territorio"
            }
          ]
        }
      },
      {
        "@type": "ItemList",
        "@id": "https://www.tuodominio.it/il-territorio#activities-list",
